...
//        super(parent, modal);
    ...
    private void initComponents() {
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtKBiayaAkhir, javax.swing.GroupLayout.DEFAULT_SIZE, 187, Short.MAX_VALUE)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    .addComponent(txtKJamMasuk, javax.swing.GroupLayout.DEFAULT_SIZE, 112, Short.MAX_VALUE)
                                    .addComponent(txtKDurasiJ))
                                .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
        ...
        setSize(new java.awt.Dimension(614, 656));
    ...
    private void tbKeluarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbKeluarMouseClicked
        // TODO add your handling code here:
        int i=tbKeluar.getSelectedRow();
        
        if (i>1){
        txtKNoPol.setText(keluar.getValueAt(i, 0).toString());
        txtKNoTiket.setText(keluar.getValueAt(i, 0).toString());
        txtKJenis.setText(keluar.getValueAt(i, 0).toString());
        txtKJamMasuk.setText(keluar.getValueAt(i, 0).toString());
        txtKDurasiH.setText(keluar.getValueAt(i, 0).toString());
        txtKDurasiJ.setText(keluar.getValueAt(i, 0).toString());
        txtKBiaya.setText(keluar.getValueAt(i, 0).toString());
        txtKBiayaAkhir.setText(keluar.getValueAt(i, 0).toString());
        }
    ...
    public void tampil_keluar(){
        ...
        try {
            konek.st = konek.conn.createStatement();
            String query = "SELECT * FROM tb_parkir WHERE biaya <> 0 and tgl_keluar = curdate() ORDER BY tgl_keluar DESC LIMIT 15";
            konek.rs = konek.st.executeQuery(query);
            while (konek.rs.next()) {
                String no_tiket = konek.rs.getString("no_tiket");
                String no_pol = konek.rs.getString("no_pol");
